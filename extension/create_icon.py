...
png_img.save("C:/Users/guzic/Documents/GitHub/wizyta/extension/icon.png")
png_img.save(f"C:/Users/guzic/Documents/GitHub/wizyta/extension/icon_{BRAND_ICON_TAG}.png")
...
png_img.save(
    "C:/Users/guzic/Documents/GitHub/wizyta/extension/icon.ico",
    sizes=ico_sizes,
)
png_img.save(
    f"C:/Users/guzic/Documents/GitHub/wizyta/extension/icon_{BRAND_ICON_TAG}.ico",
    sizes=ico_sizes,
)
...
for size in [16, 20, 24, 32, 40, 48, 64, 96, 128, 256]:
    ...
    img.save(f"C:/Users/guzic/Documents/GitHub/wizyta/extension/icon_{BRAND_ICON_TAG}_{size}.png")
